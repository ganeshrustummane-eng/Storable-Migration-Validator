...
| [0025](0025-bronze-schema-validation-visibility-and-column-count.md) | Bronze schema validation gets an explicit target-only-column check plus its own dedicated, clearly-labeled UI section (count summary + all flag groups) instead of being folded invisibly into the mapping grid | Accepted | 2026-09-25 |
