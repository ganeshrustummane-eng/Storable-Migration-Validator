...
| AI parsing | `src/ai_transformation/` (or wherever NL→spec prompts live) | Parse test-lead condition into filter/join/transformation/batch-scope spec; reuse existing rules from `rule_book.py` before inventing a new transformation |
